...
public class StandardDialog
	...
	public final JPanel main = new AntialiasPanel(new BorderLayout(0, 0));
	...
	public StandardDialog(StandardMainFrame parent, String title) {
	...
	public final void center() {
		...
		move(
			p.x + (screen.width / 2) - (dim.width / 2),
			p.y + (screen.height / 2) - (dim.height / 2));
	}
